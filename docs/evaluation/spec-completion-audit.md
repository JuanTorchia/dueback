...
| ---------------------------------------------------- | ----------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| FR-001–FR-004 intake, types, provenance, uncertainty | Verified                                              | extraction tests plus deployed contradictory-field review with visible provenance                                           |
...
| FR-033 bounded retention/deletion                    | Verified in code and development infrastructure       | transient raw bytes, pre/post-activation owner deletion, Firestore `deleteAt`, active TTL policies; TTL remains eventual    |
| FR-034 upload policy                                 | Verified                                              | content-detected bounded upload implementation and adversarial tests                                                        |
| FR-035 budgets and model telemetry                   | Verified in code and deployed infrastructure          | transactional case/model budgets, bounded task/action/notification code, observed provider tokens/latency/status/cost basis |
...
| SC-008–SC-010 | Verified for public controlled demo       | Two sequential no-retry mobile runs passed in 47.5 seconds total; sandbox and claim limits visible. |
