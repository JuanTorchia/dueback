...
| FR-035 budgets and model telemetry                   | Verified in code; deployment refresh required   | transactional case/model budgets, bounded task/action/notification code, provider tokens/latency/status/cost basis        |
