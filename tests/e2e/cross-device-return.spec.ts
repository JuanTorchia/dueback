...
test.describe("real cross-device ownership", () => {
  test.skip(!deployedUrl || !ownerState || !otherState || !caseId, "Provide two real Firebase storage states and an owned case; this claim gate cannot use mocked identity");
